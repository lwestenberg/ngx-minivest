...
export const nestedValidationSuite = staticSuite(
  (model: Partial<NestedFormModel>, field?: string) => {
    ...
    test('personalInfo.firstName', 'First name must be at least 2 characters', () => {
    ...
    test('personalInfo.lastName', 'Last name must be at least 2 characters', () => {
    ...
    test('addressInfo.zipCode', 'ZIP code must be valid (5 or 5+4 digits)', () => {
    ...
    test('personalInfo.email', 'Email is required when newsletter subscription is enabled', () => {
